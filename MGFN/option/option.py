...
def parse_args():
    ...
    parser.add_argument('--test-rgb-list', default='C:/Users/nancy/MGFN/data/ucf-i3d-test.list', help='list of test rgb features ')
    parser.add_argument('--gt', default='C:/Users/nancy/MGFN/data/gt-ucf.npy', help='file of ground truth ')
